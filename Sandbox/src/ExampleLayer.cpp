...
ExampleLayer::ExampleLayer() : Layer("Sandbox2D"), m_CameraController(1280.0f / 720.0f, true) {
	m_VertexArray = Ocean::VertexArray::Create();
	...
	Ocean::Ref<Ocean::VertexBuffer> vertexBuffer = Ocean::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Ocean::Ref<Ocean::IndexBuffer> indexBuffer = Ocean::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	m_VertexArray->SetIndexBuffer(indexBuffer);

	m_SquareVA = Ocean::VertexArray::Create();
	...
	Ocean::Ref<Ocean::VertexBuffer> squareVB = Ocean::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ Ocean::ShaderDataType::Float3, "a_Position" },
	...
	Ocean::Ref<Ocean::IndexBuffer> squareIB = Ocean::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
...
void ExampleLayer::OnUpdate(Ocean::Timestep ts) {
	/* --- Update --- */
...
void ExampleLayer::OnEvent(Ocean::Event& e) {
