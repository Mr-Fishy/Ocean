...
TEST_CASE(Bix8_Constructor_with_Initializer_List) {
    Bix8 bix = { true, false, true, false, true, false, true, false };
...
TEST_CASE(Bix8_Flip_Method) {
    ...
    bix.Flip(0);
    REQUIRE(bix.Raw() == 0b10101011);

    bix.Flip(1);
    REQUIRE(bix.Raw() == 0b10101001);
}
...
TEST_CASE(Bix8_Set_Method) {
    ...
    bix.Set(0, true);
    REQUIRE(bix.Raw() == 0b00000001);

    bix.Set(1, true);
    REQUIRE(bix.Raw() == 0b00000011);

    bix.Set(0, false);
    REQUIRE(bix.Raw() == 0b00000010);
}
